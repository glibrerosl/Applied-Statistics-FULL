...
La navegación a través de las pestañas muestra el resumen estadístico de las variables de interés: **Chace of Admit** (variable dependiente) y **TOEFL Score** (variable independiente), junto con sus respectivos diagramas de caja. Además, incluye el diagrama de dispersión de sus valores conjuntos.
...
El estudio de regresión lineal múltiple fue procesado con `r R.version.string` mediado por RStudio 2022.07.2 Build 576 en una plataforma x86_64-w64-mingw32.
...
La navegación a través de las pestañas muestra el resumen estadístico de la variable independiente **Chace of Admit**, su boxplot e histograma. De la variable dependiente **Research**
...
La navegación a través de las pestañas muestra los coeficientes del modelo de regresión lineal simple, su resumen estadístico y su tabla ANOVA. Se menciona de nuevo que las variables de interés son: **Chace of Admit** (variable independiente) y **Research** (variable dependiente).
...
Se mostrarán los resultados de algunas predicciones obtenidas a través del modelo RLogS para identificar en sus respuestas la correspondencia de sentido en las razones de probabilidades ($\pi$) a favor o en contra del evento considerado, respectivamente: $\frac{\pi}{1-\pi}$, $\frac{1-\pi}{\pi}$. Se menciona de nuevo que las variables de interés son: **Chace of Admit** (variable independiente) y **Research** (variable dependiente).
