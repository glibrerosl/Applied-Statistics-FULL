...
datos <- data.frame(chance_of_admit, research)
modelo_RLS = glm(research~chance_of_admit, family = "binomial", data = datos)
plot(research~chance_of_admit, data = datos, main = "Modelo RLogS: Chance of Admit - Research", xlab = "Chance of Admit", ylab = "Research = 0 | Research = 1", col = "gold", pch = "I")
curve(predict(modelo_RLS, data.frame(chance_of_admit = x), type = "response"), col = "orange", lwd = 3, add = TRUE)
```
