...
fviz_pca_biplot(PCA(data_All, ncp = 5, scale.unit = TRUE, graph = F, quali.sup = 7), axes = c(1, 2), repel = TRUE, habillage = 7)
```
...
fviz_pca_biplot(PCA(data_100, ncp = 5, scale.unit = TRUE, graph = F, quali.sup = 7), axes = c(1, 2), repel = TRUE, habillage = 7)
```
