...
Con base en el conjunto de datos descrito en la sección **2** se formulará un modelo de regresión lineal simple para estudiar la relación lineal supuesta entre las varaibles definidas por los campos: **Chace of Admit** (variable dependiente) y **TOEFL Score** (variable independiente).

#### 3.1.2. Desarrollo del Análisis
El estudio de regresión lineal simple fue procesado con `r R.version.string` mediado por RStudio 2022.07.2 Build 576 en una plataforma x86_64-w64-mingw32.

##### 3.1.2.1. Resumen estadístico de las variables por estudiar. {.tabset .tabset-pills}
La navegación a través de las pestañas muestra el resumen estadístico de las variables de interés: **Chace of Admit** (variable dependiente) y **TOEFL Score** (variable independiente), junto con sus respectivos diagramas de caja.
...
##### 3.1.2.2. Diagrama de dispersión de las variables por estudiar.
El diagrama de dispersión muestra los valores conjuntos de las variables de interés: **Chace of Admit** (variable dependiente) y **TOEFL Score** (variable independiente).
...
##### 3.1.2.3. Formulación del modelo de regresión lineal simple entre las variables por estudiar. {.tabset .tabset-pills}
La navegación a través de las pestañas muestra los coeficientes del modelo de regresión lineal simple, su resumen estadístico y su tabla ANOVA. Se menciona de nuevo que las variables de interés son: **Chace of Admit** (variable dependiente) y **TOEFL Score** (variable independiente).
...
##### 3.1.2.4. Inferencias sobre los parámetros del modelo. {.tabset .tabset-pills}
La navegación a través de las pestañas muestra el intervalo de confianza para $\beta_1$ y para la predicción del modelo de regresión lineal simple, ambos al 95 %. Se menciona de nuevo que las variables de interés son: **Chace of Admit** (variable dependiente) y **TOEFL Score** (variable independiente).
...
En el caso por tratar, se trabajará con base en una distribución binomial (adecuada para variables que representan una respuesta binaria) con función de enlace logit:$$\pi(x)=  \dfrac{e^{\beta_0+\beta_1 x}}{1+ e^{\beta_0 +\beta_1 x}}=  \dfrac{1}{1+ e^{-(\beta_0+\beta_1 x)}}\hspace{10mm}(--)$$(del inglés **log**arithmic un**it**: unidad logarítmica; que además es apropiada únicamente para la distribución binomial), por lo cual un nombre más adecuado para la regresión podría ser regresión logística binaria. Cabe anotar que el término logístico hace referencia a que la función de enlace constituye, en cierto sentido, un refinamiento del modelo exponencial de crecimiento, descrito por la función sigmoidea, de una magnitud asociada con un conjunto $C$.

#### 3.3.1. Planteamiento del Problema
Con base en el conjunto de datos descrito en la sección **2** se formulará un modelo de regresión logística simple para estudiar la relación logística supuesta entre las varaibles definidas por los campos: **Chace of Admit** (variable independiente) y **Research** (variable dependiente).

#### 3.3.2. Desarrollo del Análisis
El estudio de regresión lineal simple fue procesado con `r R.version.string` mediado por RStudio 2022.07.2 Build 576 en una plataforma x86_64-w64-mingw32.

##### 3.3.2.1. Resumen estadístico de la variable independiente. {.tabset .tabset-pills}
La navegación a través de las pestañas muestra el resumen estadístico de la variable independiente **Chace of Admit**, su boxplot e histograma.
