...
date: "Estudio Multivariante Elaborado entre febrero y marzo de 2023 como actividad formativa y evaluativa del curso Análisis Multivariante de la especialización en Estadística Aplicada (modalidad virtual). *Cierre de Actualizaciones T1: 2:33 p.m. del 16 de febrero de 2023*."
output:
  html_document:
    toc: TRUE
    toc_float: TRUE
...
Complementariamente, todas las pruebas de normalidad multivariante resultaron negativas. Así, el deterioro de las propiedades de independencia lineal juegan a favor de la síntesis de información a través de la estimación de componentes principales. Este asunto será tratado en el siguiente trabajo de este mismo curso.
