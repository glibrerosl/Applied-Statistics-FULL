...
Con base en el conjunto de datos descrito en la [sección 2](#sec2) se demanda determinar la calidad de representación de las variables respecto a la cantidad de dimensiones calculadas que retienen la mayor cantidad de variabilidad, ver la [sección 7](#sec7).
...
Con base en el conjunto de datos descrito en la [sección 2](#sec2) se demanda determinar las contribuciones que hace cada variable a la construcción de cada componente.
